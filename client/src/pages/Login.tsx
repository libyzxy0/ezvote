...
export default function Login() {
  return (
    <main className="hero h-screen">
      ...
      <div className="mx-8 flex flex-col items-center gap-4 mt-16">
        ...
        <div className="w-full md:w-[480px] flex flex-col">
          ...
          <input type="text" placeholder="pogiako123" className="bg-[#f7f2ee] py-2 px-4 border-2 border-black outline-none border-b-4 border-r-4 placeholder:text-gray-600" />
        </div>
